...
class Controller_Tasks extends Admin_Controller 
{
	...
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            if(in_array('updateProduct', $this->permission)) {
    			$buttons .= '<a href="'.base_url('Controller_Tasks/update/'.$value['id']).'" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>';
            }
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect('Controller_Tasks/', 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('Controller_Tasks/create', 'refresh');
        	}
        }
        else {
            // false case
	...
	{      
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if($update == true) {
                ...
                $this->session->set_flashdata('errors', 'Error occurred!!');
                redirect('Controller_Tasks/update/'.$product_id, 'refresh');
            }
        }
        else {
            // attributes 
