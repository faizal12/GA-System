	...
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateOrder', $this->permission)) {
				$buttons .= ' <a href="'.base_url('Controller_Orders/update/'.$value['id']).'" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>';
			}
