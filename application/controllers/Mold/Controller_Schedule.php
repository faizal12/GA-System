...
class Controller_Schedule extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table   = 'schedule';
        $this->load->model('Model_Schedule', 'modeldb');
    }
    public function index()
	{
		...
		$this->render_template('schedule/index', $this->data);	
	}
    // public function index()
    // {
    ...
    //     $this->render_template('schedule/index', $data);	
