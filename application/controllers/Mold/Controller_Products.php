...
class Controller_Products extends Admin_Controller 
{
    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            if(in_array('updateProduct', $this->permission)) {
    			$buttons .= '<a href="'.base_url('Controller_Products/update/'.$value['id']).'" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>';
            }
            ...
            } else if($value['qty'] <= $value['min_qty']+1) {
    ...
    public function fetchCurrentStock()
	{
		...
		$data = $this->model_products->getCurrentStock();
