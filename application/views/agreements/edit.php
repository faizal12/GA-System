              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control " id="store" name="store">
                    <option <?php if($agreement_data['reminder'] == 30) { echo "selected='selected'"; } ?> value="30">1 Month</option>
                    <option <?php if($agreement_data['reminder'] == 14) { echo "selected='selected'"; } ?> value="14">14 Days</option>
                  </select>
                </div>
