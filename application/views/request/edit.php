      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url('Controller_Requests') ?>">Requests</a></li>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('Controller_Requests/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">

                <?php echo validation_errors(); ?>

                <div class="form-group">
                  <label for="date" class="col-sm-12 control-label">Date: <?php echo date('Y-m-d H:i:s') ?></label>
                </div>

                <div class="col-md-7 col-xs-12 pull pull-left">
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Remark</label>
                    <div class="col-sm-10">
                      <textarea name="remark" id="remark" class="form-control"><?=$request_data['request']['remark']?></textarea>
                    </div>
                  </div>
                </div>
                      ...
                      <?php foreach ($request_data['request_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td><button type="button" class="btn btn-danger btn-sm" onclick="removeRow('<?php echo $x; ?>')"><i class="fa fa-times"></i></button></td>
                       </tr>
                       <?php $x++; ?>
                     <?php endforeach; ?>
                   <?php endif; ?>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'Controller_Requests/printDiv/'.$request_data['request']['id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('Controller_Requests/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
          url: base_url + '/Controller_Requests/getTableProductRow/',
          type: 'post',
          dataType: 'json',
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    ...
                    '<td><button type="button" class="btn btn-danger btn-sm" onclick="removeRow(\''+row_id+'\')"><i class="fa fa-times"></i></button></td>'+
                    '</tr>';
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'Controller_Requests/getProductValueById',
        type: 'post',
