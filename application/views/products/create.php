          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <!-- <div class="form-group">
                  ...
                  <input type="text" class="form-control" min="0" id="qty" name="qty" placeholder="Enter Qty" autocomplete="off" />
                </div> -->

                <div class="form-group">
                  <label for="min">Minimum Qty</label>
                  <input type="text" class="form-control" id="min" min="1" name="min" placeholder="Enter Minimum Qty" autocomplete="off" />
                </div>
