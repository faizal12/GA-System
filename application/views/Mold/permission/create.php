                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Reminder</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createReminder" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateReminder" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewReminder" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteReminder" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>Company</td>
                        <td> - </td>
