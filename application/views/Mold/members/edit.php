              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="form-control  select2" id="section" name="section" placeholder="Username"  required>
                      <option></option>
                      <?php foreach($section as $k => $rs):?>
                        
                        <option value="<?=$rs['section_cd']?>" <?=($user_data['section']==$rs['section_cd']) ? "selected" : ""?> ><?=$rs['section_name']?></option>
                      <?php endforeach;?>
                    </select>
                  </div>
                </div>
