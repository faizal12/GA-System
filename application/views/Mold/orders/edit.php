      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url('Controller_Orders') ?>">Orders</a></li>
              ...
              <div class="box-body">
                ...
                <div class="col-md-7 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="remark" id="remark" class="form-control"><?=$order_data['order']['remark']?></textarea>
                    </div>
                  </div>
                </div> 
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                            <input type="hidden" name="id_item[]" id="id_<?php echo $x; ?>" class="form-control" required value="<?php echo $val['id'] ?>" autocomplete="off">
                            <input type="number" name="qty[]" id="qty_<?php echo $x; ?>" min="1" class="form-control" required onkeyup="getTotal(<?php echo $x; ?>)" value="<?php echo $val['qty'] ?>" autocomplete="off">
                          </td>
                          <!-- <td>
